  ...
  return (
    <div className="min-h-screen bg-[#CCFF99] text-black">
      ...
      <section className="container mx-auto px-4 py-20 text-center">
        ...
        <Button className="bg-[#FF6B6B] hover:bg-[#FF4F4F] text-white text-lg py-6 px-8 rounded-full transition-colors">
          Start Learning Now
        </Button>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-md mx-auto bg-white rounded-lg p-8 shadow-lg">
            ...
            <form className="space-y-4">
              ...
              <Button className="w-full bg-[#FF6B6B] hover:bg-[#FF4F4F] text-white transition-colors">
                Sign Up for Free
              </Button>
            </form>
          </div>
